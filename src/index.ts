...
export interface ClientOptions {
   ...
   * - `production` corresponds to `http://api.lumalabs.ai/dream-machine/v1alpha`
   * - `production_api` corresponds to `http://internal-api.virginia.labs.lumalabs.ai/dream-machine/v1alpha`
